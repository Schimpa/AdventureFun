 ...
 */
public class Enemy_Alien_Bigdaddy extends LivingObject {
    ...
    public Enemy_Alien_Bigdaddy(MainWindow game, float x, float y, float sizeX, float sizeY, World world, Player player){
        super(game);
    ...
    public void init(float x,float y,float sizeX,float sizeY,World world){
        ...
        lives = 10;
        body.setUserData("Enemy_Alien_Bigdaddy");
        ...
        walkAnimation = new ObjectAnimation(game.getAssets().getAlien_bigdaddy(),4,1,0,3,0.08f);
